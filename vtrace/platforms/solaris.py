...
PCTWSTOP = 4L# wait for stop, with int millisecond timeout arg */
PCRUN    = 5L# make process/lwp runnable, w/ int flags argument */
...
PCKILL   = 9L# post a signal to process/lwp, int argument */
PCUNKILL = 10L# delete a pending signal from process/lwp, int arg */
...
PCSET    = 16L# set modes from int argument */
PCUNSET  = 17L# unset modes from int argument */
...
PCNICE   = 21L# set nice priority from int argument */
PCSVADDR = 22L# set %pc virtual address from int argument */
